...
if __name__ == '__main__':
    ...
    p.add_argument('--remove_erhua', action='store_true', help='remove erhua',default=True)
    p.add_argument('--remove_fillers', action='store_true', help='remove fillers',default=True)
    p.add_argument('--remove_punct', action='store_true', help='remove punct',default=True)
    args = p.parse_args()
